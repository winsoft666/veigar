#ifndef __VEIGAR_MSGPACK_V1_UNPACK_DECL_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_UNPACK_DECL_HPP
//
...
#include "veigar/msgpack/parse_return.hpp"
 ...
 * @param user_data The user_data that is set by veigar_msgpack::unpack functions.
 *
 ...
 *
 */
typedef bool (*unpack_reference_func)(veigar_msgpack::type::object_type type, std::size_t size, void* user_data);
...
void unpack_uint8(uint8_t d, veigar_msgpack::object& o);

void unpack_uint16(uint16_t d, veigar_msgpack::object& o);

void unpack_uint32(uint32_t d, veigar_msgpack::object& o);

void unpack_uint64(uint64_t d, veigar_msgpack::object& o);

void unpack_int8(int8_t d, veigar_msgpack::object& o);

void unpack_int16(int16_t d, veigar_msgpack::object& o);

void unpack_int32(int32_t d, veigar_msgpack::object& o);

void unpack_int64(int64_t d, veigar_msgpack::object& o);

void unpack_float(float d, veigar_msgpack::object& o);

void unpack_double(double d, veigar_msgpack::object& o);

void unpack_nil(veigar_msgpack::object& o);

void unpack_true(veigar_msgpack::object& o);

void unpack_false(veigar_msgpack::object& o);

struct unpack_array;

void unpack_array_item(veigar_msgpack::object& c, veigar_msgpack::object const& o);

struct unpack_map;

void unpack_map_item(veigar_msgpack::object& c, veigar_msgpack::object const& k, veigar_msgpack::object const& v);

void unpack_str(unpack_user& u, const char* p, uint32_t l, veigar_msgpack::object& o);

void unpack_bin(unpack_user& u, const char* p, uint32_t l, veigar_msgpack::object& o);

void unpack_ext(unpack_user& u, const char* p, std::size_t l, veigar_msgpack::object& o);
...
template <typename T>
typename veigar_msgpack::enable_if<sizeof(T) == sizeof(fix_tag)>::type load(uint32_t& dst, const char* n);

template <typename T>
typename veigar_msgpack::enable_if<sizeof(T) == 1>::type load(T& dst, const char* n);

template <typename T>
typename veigar_msgpack::enable_if<sizeof(T) == 2>::type load(T& dst, const char* n);

template <typename T>
typename veigar_msgpack::enable_if<sizeof(T) == 4>::type load(T& dst, const char* n);

template <typename T>
typename veigar_msgpack::enable_if<sizeof(T) == 8>::type load(T& dst, const char* n);
...
/// Unpack veigar_msgpack::object from a buffer. [obsolete]
/**
 * @param result The object_handle that contains unpacked data.
 * @param data The pointer to the buffer.
 * @param len The length of the buffer.
...
#endif // !__VEIGAR_MSGPACK_V1_UNPACK_DECL_HPP