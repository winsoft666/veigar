...
#include "veigar/msgpack/unpack_define.hpp"
#include "veigar/msgpack/cpp_config.hpp"
#include "veigar/msgpack/sysdep.hpp"
...
inline void unpack_uint8(uint8_t d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint16(uint16_t d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint32(uint32_t d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint64(uint64_t d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_int8(int8_t d, veigar_msgpack::object& o)
{ if(d >= 0) { o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = veigar_msgpack::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int16(int16_t d, veigar_msgpack::object& o)
{ if(d >= 0) { o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = veigar_msgpack::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int32(int32_t d, veigar_msgpack::object& o)
{ if(d >= 0) { o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = veigar_msgpack::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int64(int64_t d, veigar_msgpack::object& o)
{ if(d >= 0) { o.type = veigar_msgpack::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = veigar_msgpack::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_float(float d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::FLOAT32; o.via.f64 = d; }

inline void unpack_double(double d, veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::FLOAT64; o.via.f64 = d; }

inline void unpack_nil(veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::NIL; }

inline void unpack_true(veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::BOOLEAN; o.via.boolean = true; }

inline void unpack_false(veigar_msgpack::object& o)
{ o.type = veigar_msgpack::type::BOOLEAN; o.via.boolean = false; }

struct unpack_array {
    void operator()(unpack_user& u, uint32_t n, veigar_msgpack::object& o) const {
        if (n > u.limit().array()) throw veigar_msgpack::array_size_overflow("array size overflow");
        o.type = veigar_msgpack::type::ARRAY;
        o.via.array.size = 0;

#if SIZE_MAX == UINT_MAX
        if (n > SIZE_MAX/sizeof(veigar_msgpack::object))
            throw veigar_msgpack::array_size_overflow("array size overflow");
#endif // SIZE_MAX == UINT_MAX

        size_t size = n*sizeof(veigar_msgpack::object);
        o.via.array.ptr = static_cast<veigar_msgpack::object*>(u.zone().allocate_align(size, MSGPACK_ZONE_ALIGNOF(veigar_msgpack::object)));
    }
};

inline void unpack_array_item(veigar_msgpack::object& c, veigar_msgpack::object const& o)
{
#if defined(__GNUC__) && !defined(__clang__)
    std::memcpy(&c.via.array.ptr[c.via.array.size++], &o, sizeof(veigar_msgpack::object));
...
struct unpack_map {
    void operator()(unpack_user& u, uint32_t n, veigar_msgpack::object& o) const {
        if (n > u.limit().map()) throw veigar_msgpack::map_size_overflow("map size overflow");
        o.type = veigar_msgpack::type::MAP;
        o.via.map.size = 0;

#if SIZE_MAX == UINT_MAX
        if (n > SIZE_MAX/sizeof(veigar_msgpack::object_kv))
            throw veigar_msgpack::map_size_overflow("map size overflow");
#endif // SIZE_MAX == UINT_MAX

        size_t size = n*sizeof(veigar_msgpack::object_kv);
        o.via.map.ptr = static_cast<veigar_msgpack::object_kv*>(u.zone().allocate_align(size, MSGPACK_ZONE_ALIGNOF(veigar_msgpack::object_kv)));
    }
};

inline void unpack_map_item(veigar_msgpack::object& c, veigar_msgpack::object const& k, veigar_msgpack::object const& v)
{
#if defined(__GNUC__) && !defined(__clang__)
    std::memcpy(&c.via.map.ptr[c.via.map.size].key, &k, sizeof(veigar_msgpack::object));
    std::memcpy(&c.via.map.ptr[c.via.map.size].val, &v, sizeof(veigar_msgpack::object));
#else  /* __GNUC__ && !__clang__ */
...
inline void unpack_str(unpack_user& u, const char* p, uint32_t l, veigar_msgpack::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().str()) throw veigar_msgpack::str_size_overflow("str size overflow");
...
inline void unpack_bin(unpack_user& u, const char* p, uint32_t l, veigar_msgpack::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().bin()) throw veigar_msgpack::bin_size_overflow("bin size overflow");
        char* tmp = static_cast<char*>(u.zone().allocate_align(l, MSGPACK_ZONE_ALIGNOF(char)));
        std::memcpy(tmp, p, l);
        o.via.bin.ptr = tmp;
    }
...
inline void unpack_ext(unpack_user& u, const char* p, std::size_t l, veigar_msgpack::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().ext()) throw veigar_msgpack::ext_size_overflow("ext size overflow");
        char* tmp = static_cast<char*>(u.zone().allocate_align(l, MSGPACK_ZONE_ALIGNOF(char)));
        std::memcpy(tmp, p, l);
        o.via.ext.ptr = tmp;
    }
...
class unpack_stack {
public:
    veigar_msgpack::object const& obj() const { return m_obj; }
    veigar_msgpack::object& obj() { return m_obj; }
    void set_obj(veigar_msgpack::object const& obj) { m_obj = obj; }
    ...
    veigar_msgpack::object const& map_key() const { return m_map_key; }
    void set_map_key(veigar_msgpack::object const& map_key) { m_map_key = map_key; }
private:
    veigar_msgpack::object m_obj;
    std::size_t m_count;
    uint32_t m_container_type;
    veigar_msgpack::object m_map_key;
};
...
template <typename T>
inline typename veigar_msgpack::enable_if<sizeof(T) == sizeof(fix_tag)>::type load(uint32_t& dst, const char* n) {
    dst = static_cast<uint32_t>(*reinterpret_cast<const uint8_t*>(n)) & 0x0f;
}

template <typename T>
inline typename veigar_msgpack::enable_if<sizeof(T) == 1>::type load(T& dst, const char* n) {
    dst = static_cast<T>(*reinterpret_cast<const uint8_t*>(n));
}

template <typename T>
inline typename veigar_msgpack::enable_if<sizeof(T) == 2>::type load(T& dst, const char* n) {
    _msgpack_load16(T, n, &dst);
}

template <typename T>
inline typename veigar_msgpack::enable_if<sizeof(T) == 4>::type load(T& dst, const char* n) {
    _msgpack_load32(T, n, &dst);
}

template <typename T>
inline typename veigar_msgpack::enable_if<sizeof(T) == 8>::type load(T& dst, const char* n) {
...
public:
    ...
    void init()
    {
        ...
        m_trail = 0;
        m_stack.resize(1);
        m_stack[0].set_obj(veigar_msgpack::object());
    }
...
private:
    ...
    int push_aggregate(
        ...
        if(tmp == 0) {
            ...
            if (m_stack.size() <= m_user.limit().depth()) {
                ...
                throw veigar_msgpack::depth_size_overflow("depth size overflow");
            }
            m_cs = MSGPACK_CS_HEADER;
            ++m_current;
        }
    ...
    int push_item(veigar_msgpack::object& obj) {
        bool finish = false;
        while (!finish) {
            if(m_stack.size() == 1) {
                return 1;
    ...
    int push_proc(veigar_msgpack::object& obj, std::size_t& off) {
...
inline void context::check_ext_size<4>(std::size_t size) {
    if (size == 0xffffffff) throw veigar_msgpack::ext_size_overflow("ext size overflow");
}
...
public:
    ...
    /// Notify a buffer consumed information to veigar_msgpack::unpacker.
    /**
    ...
    /// Unpack one veigar_msgpack::object. [obsolete]
    /**
     *
    ...
    /*! for backward compatibility */
    veigar_msgpack::object const& data();
...
inline unpacker::unpacker(unpack_reference_func f,
    ...
    :m_z(new veigar_msgpack::zone), m_ctx(f, user_data, limit)
{
...
inline veigar_msgpack::object const& unpacker::data()
{
    return m_ctx.data();
}
...
inline bool unpacker::default_reference_func(veigar_msgpack::type::object_type /*type*/, std::size_t /*len*/, void*)
{
    return true;
}
