#ifndef __VEIGAR_MSGPACK_V1_DETAIL_CPP11_ZONE_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_DETAIL_CPP11_ZONE_HPP
//
...
#include "veigar/msgpack/zone_decl.hpp"
...
public:
    ...
    template <typename T>
    void push_finalizer(veigar_msgpack::unique_ptr<T> obj);
...
template <typename T>
inline void zone::push_finalizer(veigar_msgpack::unique_ptr<T> obj)
{
...
#endif // !__VEIGAR_MSGPACK_V1_DETAIL_CPP11_ZONE_HPP