#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_EXT_DECL_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_EXT_DECL_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_EXT_DECL_HPP