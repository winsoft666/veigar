#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_OPTIONAL_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_OPTIONAL_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_OPTIONAL_HPP