#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_STRING_VIEW_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_STRING_VIEW_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_STRING_VIEW_HPP