#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_MSGPACK_VARIANT_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_MSGPACK_VARIANT_HPP
//
...
#include "veigar/msgpack/adaptor/nil.hpp"
#include "veigar/msgpack/adaptor/bool.hpp"
#include "veigar/msgpack/adaptor/int.hpp"
#include "veigar/msgpack/adaptor/float.hpp"
#include "veigar/msgpack/adaptor/string.hpp"
#include "veigar/msgpack/adaptor/vector_char.hpp"
#include "veigar/msgpack/adaptor/raw.hpp"
#include "veigar/msgpack/adaptor/ext.hpp"
#include "veigar/msgpack/adaptor/vector.hpp"
#include "veigar/msgpack/adaptor/map.hpp"
...
struct basic_variant :
    boost::variant<
        ...
        std::vector<char>, // BIN
        veigar_msgpack::type::raw_ref, // BIN
        veigar_msgpack::type::ext,               // EXT
        veigar_msgpack::type::ext_ref,           // EXT
    ...
    bool is_nil() const {
        return boost::get<veigar_msgpack::type::nil_t>(this) != MSGPACK_NULLPTR;
    }
    bool is_bool() const {
...
struct as<type::basic_variant<STR, BIN, EXT> > {
    type::basic_variant<STR, BIN, EXT> operator()(veigar_msgpack::object const& o) const {
        switch(o.type) {
        case type::NIL:
            return o.as<veigar_msgpack::type::nil_t>();
        case type::BOOLEAN:
            return o.as<bool>();
...
struct convert<type::basic_variant<STR, BIN, EXT> > {
    veigar_msgpack::object const& operator()(
        ...
        switch(o.type) {
        case type::NIL:
            v = o.as<veigar_msgpack::type::nil_t>();
            break;
        case type::BOOLEAN:
            v = o.as<bool>();
            break;
...
struct pack<type::basic_variant<STR, BIN, EXT> > {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_imp : boost::static_visitor<void> {
    void operator()(veigar_msgpack::type::nil_t const& v) const {
        object<veigar_msgpack::type::nil_t>()(o_, v);
    }
    ...
    object_imp(veigar_msgpack::object& o):o_(o) {}
    veigar_msgpack::object& o_;
};
...
struct object<type::basic_variant<STR, BIN, EXT> > {
    void operator()(veigar_msgpack::object& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_with_zone_imp : boost::static_visitor<void> {
    ...
    object_with_zone_imp(veigar_msgpack::object::with_zone& o):o_(o) {}
    veigar_msgpack::object::with_zone& o_;
};
...
struct object_with_zone<type::basic_variant<STR, BIN, EXT> > {
    void operator()(veigar_msgpack::object::with_zone& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_BOOST_MSGPACK_VARIANT_HPP