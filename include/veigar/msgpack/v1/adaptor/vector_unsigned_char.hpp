#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_UNSIGNED_CHAR_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_UNSIGNED_CHAR_HPP
//
...
struct convert<std::vector<unsigned char, Alloc> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, std::vector<unsigned char, Alloc>& v) const {
        switch (o.type) {
...
struct pack<std::vector<unsigned char, Alloc> > {
    ...
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const std::vector<unsigned char, Alloc>& v) const {
...
struct object<std::vector<unsigned char, Alloc> > {
    void operator()(veigar_msgpack::object& o, const std::vector<unsigned char, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
...
struct object_with_zone<std::vector<unsigned char, Alloc> > {
    void operator()(veigar_msgpack::object::with_zone& o, const std::vector<unsigned char, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.type = veigar_msgpack::type::BIN;
        o.via.bin.size = size;
        if (size != 0) {
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_UNSIGNED_CHAR_HPP