#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_ARRAY_REF_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_ARRAY_REF_HPP
//
...
template <typename T>
struct convert<veigar_msgpack::type::array_ref<T> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, veigar_msgpack::type::array_ref<T>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
        if (o.type != veigar_msgpack::type::ARRAY) { throw veigar_msgpack::type_error(); }
        if (v.size() < o.via.bin.size) { throw veigar_msgpack::type_error(); }
...
template <typename T, std::size_t N>
struct convert<veigar_msgpack::type::array_ref<T[N]> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, veigar_msgpack::type::array_ref<T[N]>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
        if (o.type != veigar_msgpack::type::ARRAY) { throw veigar_msgpack::type_error(); }
        if (v.size() < o.via.bin.size) { throw veigar_msgpack::type_error(); }
        if (o.via.array.size > 0) {
...
template <typename T>
struct convert<veigar_msgpack::type::array_ref<std::vector<T> > > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, veigar_msgpack::type::array_ref<std::vector<T> >& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
        if (o.type != veigar_msgpack::type::ARRAY) { throw veigar_msgpack::type_error(); }
...
template <typename T>
struct pack<veigar_msgpack::type::array_ref<T> > {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const veigar_msgpack::type::array_ref<T>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
...
template <typename T, std::size_t N>
struct pack<veigar_msgpack::type::array_ref<T[N]> > {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const veigar_msgpack::type::array_ref<T[N]>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
        uint32_t size = checked_get_container_size(v.size());
        o.pack_array(size);
...
template <typename T>
struct object_with_zone<veigar_msgpack::type::array_ref<T> > {
    void operator()(veigar_msgpack::object::with_zone& o, const veigar_msgpack::type::array_ref<T>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
...
template <typename T, std::size_t N>
struct object_with_zone<veigar_msgpack::type::array_ref<T[N]> > {
    void operator()(veigar_msgpack::object::with_zone& o, const veigar_msgpack::type::array_ref<T[N]>& v) const {
        if (!v.data) { throw veigar_msgpack::type_error(); }
        o.type = veigar_msgpack::type::ARRAY;
        uint32_t size = checked_get_container_size(v.size());
        veigar_msgpack::object* p = static_cast<veigar_msgpack::object*>(o.zone.allocate_align(sizeof(veigar_msgpack::object)*size, MSGPACK_ZONE_ALIGNOF(veigar_msgpack::object)));
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_ARRAY_REF_HPP