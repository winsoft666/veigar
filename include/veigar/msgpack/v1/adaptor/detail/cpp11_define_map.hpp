...
#include "veigar/msgpack/v1/adaptor/detail/cpp11_convert_helper.hpp"
...
struct define_map_imp {
    ...
    static void unpack(
        veigar_msgpack::object const& o, Tuple const& t,
        std::map<std::string, veigar_msgpack::object const*> const& kvmap) {
    ...
    static void object(veigar_msgpack::object* o, veigar_msgpack::zone& z, Tuple const& t) {
        define_map_imp<Tuple, N-2>::object(o, z, t);
        o->via.map.ptr[(N-1)/2].key = veigar_msgpack::object(std::get<N-2>(t), z);
        o->via.map.ptr[(N-1)/2].val = veigar_msgpack::object(std::get<N-1>(t), z);
    }
};
...
struct define_map_imp<Tuple, 0> {
    ...
    static void unpack(
        veigar_msgpack::object const&, Tuple const&,
        std::map<std::string, veigar_msgpack::object const*> const&) {}
    static void object(veigar_msgpack::object*, veigar_msgpack::zone&, Tuple const&) {}
};
...
struct define_map {
    ...
    void msgpack_object(veigar_msgpack::object* o, veigar_msgpack::zone& z) const
    {
        ...
        o->via.map.ptr = static_cast<veigar_msgpack::object_kv*>(z.allocate_align(sizeof(veigar_msgpack::object_kv)*sizeof...(Args)/2, MSGPACK_ZONE_ALIGNOF(veigar_msgpack::object_kv)));
