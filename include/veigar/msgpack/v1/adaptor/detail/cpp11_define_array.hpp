...
#include "veigar/msgpack/v1/adaptor/detail/cpp11_define_array_decl.hpp"
...
struct define_array_imp {
    ...
    static void unpack(veigar_msgpack::object const& o, Tuple& t) {
    ...
    static void object(veigar_msgpack::object* o, veigar_msgpack::zone& z, Tuple const& t) {
        ...
        o->via.array.ptr[N-1] = veigar_msgpack::object(std::get<N-1>(t), z);
    }
};
...
struct define_array_imp<Tuple, 1> {
    ...
    static void object(veigar_msgpack::object* o, veigar_msgpack::zone& z, Tuple const& t) {
        o->via.array.ptr[0] = veigar_msgpack::object(std::get<0>(t), z);
    }
};
...
struct define_array {
    ...
    void msgpack_object(veigar_msgpack::object* o, veigar_msgpack::zone& z) const
    {
        ...
        o->via.array.ptr = static_cast<veigar_msgpack::object*>(z.allocate_align(sizeof(veigar_msgpack::object)*sizeof...(Args), MSGPACK_ZONE_ALIGNOF(veigar_msgpack::object)));
