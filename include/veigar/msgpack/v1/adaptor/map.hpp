...
#include "veigar/msgpack/v1/adaptor/map_decl.hpp"
...
struct as<
    ...
    type::assoc_vector<K, V, Compare, Alloc> operator()(veigar_msgpack::object const& o) const {
...
struct convert<type::assoc_vector<K, V, Compare, Alloc> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, type::assoc_vector<K, V, Compare, Alloc>& v) const {
        if (o.type != veigar_msgpack::type::MAP) { throw veigar_msgpack::type_error(); }
...
struct pack<type::assoc_vector<K, V, Compare, Alloc> > {
    ...
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const type::assoc_vector<K, V, Compare, Alloc>& v) const {
...
struct object_with_zone<type::assoc_vector<K, V, Compare, Alloc> > {
    void operator()(veigar_msgpack::object::with_zone& o, const type::assoc_vector<K, V, Compare, Alloc>& v) const {
...
struct as<
    ...
    typename std::enable_if<veigar_msgpack::has_as<K>::value || veigar_msgpack::has_as<V>::value>::type> {
    std::map<K, V, Compare, Alloc> operator()(veigar_msgpack::object const& o) const {
        if (o.type != veigar_msgpack::type::MAP) { throw veigar_msgpack::type_error(); }
        veigar_msgpack::object_kv* p(o.via.map.ptr);
        veigar_msgpack::object_kv* const pend(o.via.map.ptr + o.via.map.size);
...
struct convert<std::map<K, V, Compare, Alloc> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, std::map<K, V, Compare, Alloc>& v) const {
        if (o.type != veigar_msgpack::type::MAP) { throw veigar_msgpack::type_error(); }
        veigar_msgpack::object_kv* p(o.via.map.ptr);
        veigar_msgpack::object_kv* const pend(o.via.map.ptr + o.via.map.size);
...
struct pack<std::map<K, V, Compare, Alloc> > {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const std::map<K, V, Compare, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.pack_map(size);
...
struct object_with_zone<std::map<K, V, Compare, Alloc> > {
    void operator()(veigar_msgpack::object::with_zone& o, const std::map<K, V, Compare, Alloc>& v) const {
        o.type = veigar_msgpack::type::MAP;
        if (v.empty()) {
            o.via.map.ptr  = MSGPACK_NULLPTR;
            o.via.map.size = 0;
...
struct as<
    ...
    typename std::enable_if<veigar_msgpack::has_as<K>::value || veigar_msgpack::has_as<V>::value>::type> {
    std::multimap<K, V, Compare, Alloc> operator()(veigar_msgpack::object const& o) const {
        if (o.type != veigar_msgpack::type::MAP) { throw veigar_msgpack::type_error(); }
        veigar_msgpack::object_kv* p(o.via.map.ptr);
        veigar_msgpack::object_kv* const pend(o.via.map.ptr + o.via.map.size);
...
struct convert<std::multimap<K, V, Compare, Alloc> > {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, std::multimap<K, V, Compare, Alloc>& v) const {
        if (o.type != veigar_msgpack::type::MAP) { throw veigar_msgpack::type_error(); }
        veigar_msgpack::object_kv* p(o.via.map.ptr);
        veigar_msgpack::object_kv* const pend(o.via.map.ptr + o.via.map.size);
...
struct pack<std::multimap<K, V, Compare, Alloc> > {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const std::multimap<K, V, Compare, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.pack_map(size);
...
struct object_with_zone<std::multimap<K, V, Compare, Alloc> > {
    void operator()(veigar_msgpack::object::with_zone& o, const std::multimap<K, V, Compare, Alloc>& v) const {
        o.type = veigar_msgpack::type::MAP;
        if (v.empty()) {
            o.via.map.ptr  = MSGPACK_NULLPTR;
            o.via.map.size = 0;
