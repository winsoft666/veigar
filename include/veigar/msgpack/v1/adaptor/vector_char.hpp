#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_CHAR_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_CHAR_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_VECTOR_CHAR_HPP