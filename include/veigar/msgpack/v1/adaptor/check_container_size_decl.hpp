#ifndef __VEIGAR_MSGPACK_V1_ADAPTOR_CHECK_CONTAINER_SIZE_DECL_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V1_ADAPTOR_CHECK_CONTAINER_SIZE_DECL_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V1_ADAPTOR_CHECK_CONTAINER_SIZE_DECL_HPP