...
#include "veigar/msgpack/v1/adaptor/ext_decl.hpp"
...
public:
    ...
    ext(int8_t t, const char* p, uint32_t s) {
        veigar_msgpack::detail::check_container_size_for_ext<sizeof(std::size_t)>(s);
...
template <>
struct convert<veigar_msgpack::type::ext> {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, veigar_msgpack::type::ext& v) const {
        if(o.type != veigar_msgpack::type::EXT) {
            throw veigar_msgpack::type_error();
        }
        v = veigar_msgpack::type::ext(o.via.ext.type(), o.via.ext.data(), o.via.ext.size);
        return o;
    }
};

template <>
struct pack<veigar_msgpack::type::ext> {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const veigar_msgpack::type::ext& v) const {
...
template <>
struct object_with_zone<veigar_msgpack::type::ext> {
    void operator()(veigar_msgpack::object::with_zone& o, const veigar_msgpack::type::ext& v) const {
        // size limit has already been checked at ext's constructor
        uint32_t size = v.size();
...
private:
    const char* m_ptr;
    uint32_t m_size;
    friend struct adaptor::object<veigar_msgpack::type::ext_ref>;
};
...
template <>
struct convert<veigar_msgpack::type::ext_ref> {
    veigar_msgpack::object const& operator()(veigar_msgpack::object const& o, veigar_msgpack::type::ext_ref& v) const {
        if(o.type != veigar_msgpack::type::EXT) { throw veigar_msgpack::type_error(); }
        v = veigar_msgpack::type::ext_ref(o.via.ext.ptr, o.via.ext.size + 1);
        return o;
    }
};

template <>
struct pack<veigar_msgpack::type::ext_ref> {
    template <typename Stream>
    veigar_msgpack::packer<Stream>& operator()(veigar_msgpack::packer<Stream>& o, const veigar_msgpack::type::ext_ref& v) const {
        // size limit has already been checked at ext_ref's constructor
        uint32_t size = v.size();
        o.pack_ext(size, v.type());
        o.pack_ext_body(v.data(), size);
...
template <>
struct object<veigar_msgpack::type::ext_ref> {
    void operator()(veigar_msgpack::object& o, const veigar_msgpack::type::ext_ref& v) const {
        // size limit has already been checked at ext_ref's constructor
        uint32_t size = v.size();
        o.type = veigar_msgpack::type::EXT;
...
template <>
struct object_with_zone<veigar_msgpack::type::ext_ref> {
    void operator()(veigar_msgpack::object::with_zone& o, const veigar_msgpack::type::ext_ref& v) const {
