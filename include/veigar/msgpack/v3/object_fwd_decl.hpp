#ifndef __VEIGAR_MSGPACK_V3_OBJECT_FWD_DECL_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V3_OBJECT_FWD_DECL_HPP
//
...
#endif // !__VEIGAR_MSGPACK_V3_OBJECT_FWD_DECL_HPP