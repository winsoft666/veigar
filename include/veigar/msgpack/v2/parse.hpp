#ifndef __VEIGAR_MSGPACK_V2_PARSE_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V2_PARSE_HPP
//
...
inline bool parse(const char* data, size_t len, size_t& off, Visitor& v) {
    parse_return ret = veigar_msgpack::detail::parse_imp(data, len, off, v);
...
inline bool parse(const char* data, size_t len, Visitor& v) {
    std::size_t off = 0;
    return veigar_msgpack::parse(data, len, off, v);
}
...
#endif // !__VEIGAR_MSGPACK_V2_PARSE_HPP