#ifndef __VEIGAR_MSGPACK_V2_OBJECT_FWD_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_V2_OBJECT_FWD_HPP
//
...
struct object : v1::object {
     ...
     */
    template <typename T>
    object(const T& v, veigar_msgpack::zone& z):v1::object(v, z) {}
...
#endif // !__VEIGAR_MSGPACK_V2_OBJECT_FWD_HPP