#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_SELECTION_MIN_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_SELECTION_MIN_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_SELECTION_MIN_HPP