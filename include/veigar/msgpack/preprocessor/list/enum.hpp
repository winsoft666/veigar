#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_LIST_ENUM_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_LIST_ENUM_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_LIST_ENUM_HPP