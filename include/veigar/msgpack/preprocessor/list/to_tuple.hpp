#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_LIST_TO_TUPLE_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_LIST_TO_TUPLE_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_LIST_TO_TUPLE_HPP