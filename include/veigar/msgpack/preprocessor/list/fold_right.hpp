#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_LIST_FOLD_RIGHT_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_LIST_FOLD_RIGHT_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#    include <veigar/msgpack/preprocessor/list/detail/edg/fold_right.hpp>
# else
#    include <veigar/msgpack/preprocessor/list/detail/fold_right.hpp>
# endif
#
# endif

#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_LIST_FOLD_RIGHT_HPP