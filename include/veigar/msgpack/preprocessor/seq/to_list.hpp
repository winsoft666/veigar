#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_SEQ_TO_LIST_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_SEQ_TO_LIST_HPP
# /* **************************************************************************
#  *                                                                          *
...
# include <veigar/msgpack/preprocessor/seq/detail/binary_transform.hpp>
#
# /* MSGPACK_PP_SEQ_TO_LIST */
#
# if MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_MSVC()
# include <veigar/msgpack/preprocessor/seq/size.hpp>
# include <veigar/msgpack/preprocessor/seq/detail/to_list_msvc.hpp>
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_SEQ_TO_LIST_HPP