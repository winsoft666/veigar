#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_WHILE_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_WHILE_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#
# if MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_EDG()
#    include <veigar/msgpack/preprocessor/control/detail/edg/while.hpp>
# elif MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_MSVC()
#    include <veigar/msgpack/preprocessor/control/detail/msvc/while.hpp>
# elif MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_DMC()
#    include <veigar/msgpack/preprocessor/control/detail/dmc/while.hpp>
# else
#    include <veigar/msgpack/preprocessor/control/detail/while.hpp>
# endif
#
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_WHILE_HPP