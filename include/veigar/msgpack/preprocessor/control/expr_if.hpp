#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_EXPR_IF_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_EXPR_IF_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_CONTROL_EXPR_IF_HPP