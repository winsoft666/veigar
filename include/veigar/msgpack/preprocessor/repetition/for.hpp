#ifndef __VEIGAR_MSGPACK_PREPROCESSOR_REPETITION_FOR_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_PREPROCESSOR_REPETITION_FOR_HPP
# /* Copyright (C) 2001
#  * Housemarque Oy
...
# include <veigar/msgpack/preprocessor/debug/error.hpp>
# include <veigar/msgpack/preprocessor/facilities/empty.hpp>
# include <veigar/msgpack/preprocessor/logical/bool.hpp>
...
#    include <veigar/msgpack/preprocessor/repetition/detail/edg/for.hpp>
# elif MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_MSVC()
#    include <veigar/msgpack/preprocessor/repetition/detail/msvc/for.hpp>
# elif MSGPACK_PP_CONFIG_FLAGS() & MSGPACK_PP_CONFIG_DMC()
#    include <veigar/msgpack/preprocessor/repetition/detail/dmc/for.hpp>
# else
#    include <veigar/msgpack/preprocessor/repetition/detail/for.hpp>
# endif
#
...
#endif // !__VEIGAR_MSGPACK_PREPROCESSOR_REPETITION_FOR_HPP