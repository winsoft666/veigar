#ifndef __VEIGAR_MSGPACK_ADAPTOR_TR1_UNORDERED_MAP_HPP // Add by msgpack.py
#define __VEIGAR_MSGPACK_ADAPTOR_TR1_UNORDERED_MAP_HPP
//
...
#endif // !__VEIGAR_MSGPACK_ADAPTOR_TR1_UNORDERED_MAP_HPP